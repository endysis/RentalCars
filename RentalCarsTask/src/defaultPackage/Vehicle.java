...
public class Vehicle {
 ...
 public Vehicle(String s, String n, double p, String su, double r) { // Bind all input values to object variables
  sipp = s;
  name = n;
  price = p;
  supplier = su;
  rating = r;
  this.setVehicleScore(); // Set vehicle score on construction
 }
